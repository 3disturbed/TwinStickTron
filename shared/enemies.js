...
export const ENEMIES = {
  ...
  [EK.BRUTE_PRIME]: {
    ...
    hp: 60, speed: 30, score: 500, coreValue: 30, cost: 0, ai: "boss_brute", dropChance: 1,
    boss: true, fireEvery: 4.0,
    onDeath: { split: EK.MITE, count: 6 },
  },
  [EK.HEX_PRIME]: {
    name: "HEXAGON PRIME", shape: "hexring", radius: 56, color: "#39f0ff",
    hp: 90, speed: 14, score: 1000, coreValue: 30, cost: 0, ai: "boss_hex", dropChance: 1,
    boss: true, fireEvery: 0.55,   // rotating spokes cadence
  },
  [EK.FOUNDRY]: {
    name: "FOUNDRY", shape: "block", radius: 60, color: "#ff8c5b",
    hp: 120, speed: 6, score: 1600, coreValue: 30, cost: 0, ai: "boss_foundry", dropChance: 1,
  ...
  [EK.SHEPHERD]: {
    ...
    hp: 140, speed: 26, score: 2200, coreValue: 30, cost: 0, ai: "boss_shepherd", dropChance: 1,
  ...
  [EK.ULTRADARK]: {
    ...
    hp: 180, speed: 34, score: 5000, coreValue: 30, cost: 0, ai: "boss_ultra", dropChance: 1,
